parameters = [
  ...
  { name = "dev.user.redis_host", value = "elasticache-dev-elasticache.sksxsr.ng.0001.use1.cache.amazonaws.com:6379" },
  { name = "dev.user.mongo_endpoint", value = "mongodb-dev.sonydevops.online" },
  { name = "dev.cart.redis_host", value = "elasticache-dev-elasticache.sksxsr.ng.0001.use1.cache.amazonaws.com:6379" },
  ...
  { name = "dev.rds.db_host", value = "mysql-dev.sonydevops.online" },
