parameters = [
  ...
  { name = "dev.user.redis_host", value = "elasticache-dev-elasticache.sksxsr.ng.0001.use1.cache.amazonaws.com" },
  { name = "dev.user.mongo_endpoint", value = "mongodb-dev.sonydevops.online" },
  { name = "dev.cart.redis_host", value = "elasticache-dev-elasticache.sksxsr.ng.0001.use1.cache.amazonaws.com" },
  { name = "dev.cart.catalogue_host", value = "catalogue-dev.sonydevops.online" },
  { name = "dev.cart.catalogue_port", value = "80" },
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.sonydevops.online:80" },
  { name = "dev.rds.db_host", value = "rds-dev-rds.cluster-c8ufbqeyvx3w.us-east-1.rds.amazonaws.com" },
...
passwords = [
  ...
  { name = "dev.user.mongo_url", value = "'mongodb://roboShop:roboShop123456@docdb-dev-0.c8ufbqeyvx3w.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false'" }
